...
func NewAccount(accountId int32, type_ int32, email string, name string, creationDate time.Time, updateDate time.Time) *Account {
	this := Account{}
...
// and a boolean to check if the value has been set.
func (o *Account) GetTypeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *Account) SetType(v int32) {
	o.Type = v
}
...
func (o *Account) GetEmailVerified() bool {
...
// and a boolean to check if the value has been set.
func (o *Account) GetEmailVerifiedOk() (*bool, bool) {
	if o == nil || IsNil(o.EmailVerified) {
		return nil, false
	}
...
func (o *Account) HasEmailVerified() bool {
	if o != nil && !IsNil(o.EmailVerified) {
		return true
	}
...
func (o *Account) SetEmailVerified(v bool) {
	o.EmailVerified = &v
}
...
func (o *Account) GetMasterAccountId() int32 {
...
// and a boolean to check if the value has been set.
func (o *Account) GetMasterAccountIdOk() (*int32, bool) {
	if o == nil || IsNil(o.MasterAccountId) {
		return nil, false
	}
...
func (o *Account) HasMasterAccountId() bool {
	if o != nil && !IsNil(o.MasterAccountId) {
		return true
	}
...
func (o *Account) SetMasterAccountId(v int32) {
	o.MasterAccountId = &v
}

// GetRights returns the Rights field value if set, zero value otherwise.
func (o *Account) GetRights() int32 {
...
// and a boolean to check if the value has been set.
func (o *Account) GetRightsOk() (*int32, bool) {
	if o == nil || IsNil(o.Rights) {
		return nil, false
	}
...
func (o *Account) SetRights(v int32) {
	o.Rights = &v
}
...
func (o *Account) GetCreationDate() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Account) GetCreationDateOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Account) SetCreationDate(v time.Time) {
	o.CreationDate = v
}

// GetUpdateDate returns the UpdateDate field value
func (o *Account) GetUpdateDate() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Account) GetUpdateDateOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Account) SetUpdateDate(v time.Time) {
	o.UpdateDate = v
}

// GetDescent returns the Descent field value if set, zero value otherwise.
func (o *Account) GetDescent() AccountDescent {
...
// and a boolean to check if the value has been set.
func (o *Account) GetDescentOk() (*AccountDescent, bool) {
	if o == nil || IsNil(o.Descent) {
		return nil, false
	}
...
func (o *Account) HasDescent() bool {
	if o != nil && !IsNil(o.Descent) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Account) GetShsSubscriptionTypeOk() (*string, bool) {
	if o == nil || IsNil(o.ShsSubscriptionType) {
		return nil, false
	}
...
func (o *Account) HasShsSubscriptionType() bool {
	if o != nil && !IsNil(o.ShsSubscriptionType) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Account) GetB2bActiveOk() (*bool, bool) {
	if o == nil || IsNil(o.B2bActive) {
		return nil, false
	}
...
func (o *Account) HasB2bActive() bool {
	if o != nil && !IsNil(o.B2bActive) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Account) GetApiTermsOfUseOk() (*TermsOfUse, bool) {
	if o == nil || IsNil(o.ApiTermsOfUse) {
		return nil, false
	}
...
func (o *Account) HasApiTermsOfUse() bool {
	if o != nil && !IsNil(o.ApiTermsOfUse) {
		return true
	}
...
func (o *Account) SetApiTermsOfUse(v TermsOfUse) {
	o.ApiTermsOfUse = &v
}
